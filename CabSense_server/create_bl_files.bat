...
if "%PATH_GCCARM%"=="" (
  set OBJCOPY="D:\CU_Boulder\ECEN_5023\Simplicity_Studio\developer\toolchains\gnu_arm\7.2_2017q4\bin\arm-none-eabi-objcopy.exe"
) else (
...
if "%PATH_SCMD%"=="" (
  set COMMANDER="D:\CU_Boulder\ECEN_5023\Simplicity_Studio\developer\adapter_packs\commander\commander.exe"
) else (
